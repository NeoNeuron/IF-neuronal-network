...
all : net.out nets.out spike.out spike2.out lfp.out mi.out mi_dd.out mi_bd.out autocov.out surrogate.out surrogate2d.out means.out stds.out transpose.out split.out move
