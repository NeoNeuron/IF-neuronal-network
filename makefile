...
all : net.out nets.out spike.out spike2.out lfp.out mi.out mi_dd.out mi_dd_LFP.out mi_bd.out mi_bb.out autocov.out means.out stds.out transpose.out sta.out move
