...
for i in range(num_trial):
    ...
    subprocess.call(['./bin/transpose.out', './data/tmp/I.csv'])
    subprocess.call(['./bin/split.out', './data/tmp/I.csv', './data/tmp/n1i.csv', './data/tmp/n2i.csv'])
