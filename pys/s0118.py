...
p = subprocess.call(['./bin/net.out', args.dir])
#p = 0
if p == 0:
    ...
    subprocess.call(['./bin/lfp.out', args.dir + '/I.bin', args.dir + '/lfp.bin'])
    ...
    process_num = 10
    delay_range = '15,15'
    subprocess.call(['python3', 'pys/mi_lfp_scan.py', args.dir, str(neuron_num), delay_range, str(process_num)])

    # import mutual information data

    mi_dat = np.genfromtxt(args.dir + '/mi_lfp_scan.csv', delimiter = ',')

    # draw grid plot of maximum mutual information
